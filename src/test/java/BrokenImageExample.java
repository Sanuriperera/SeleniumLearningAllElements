...
public class BrokenImageExample {
    ...
    public void openImagePage(){
        ...
        File file=new File("C:\\Users\\Sanuri\\Downloads\\SelectorsHub-XPath-Helper-Chrome-Web-Store.crx");
    ...
    public void findBrokenImageTest(){
        ...
        //"naturalWidth"='0' --> this means the image is broken

        int i =1;
        for(WebElement image:images){
            if(image.getAttribute("naturalWidth").equals("0")){
                System.out.println("The image "+i+"is broken ");
            }else{
